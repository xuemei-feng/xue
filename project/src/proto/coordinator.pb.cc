...
PROTOBUF_CONSTEXPR ReplyProxyIPsPorts::ReplyProxyIPsPorts(
  ...
  , /*decltype(_impl_.append_block_ids_)*/{}
  , /*decltype(_impl_._append_block_ids_cached_byte_size_)*/{0}
  , /*decltype(_impl_.append_block_counts_)*/{}
  , /*decltype(_impl_._append_block_counts_cached_byte_size_)*/{0}
...
const uint32_t TableStruct_coordinator_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::coordinator_proto::ReplyProxyIPsPorts, _impl_.append_block_ids_),
  PROTOBUF_FIELD_OFFSET(::coordinator_proto::ReplyProxyIPsPorts, _impl_.append_block_counts_),
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_coordinator_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "\003(\005\022\036\n\026cord_transfer_plan_key\030\007 \001(\t\022\030\n\020a"
  "ppend_block_ids\030\010 \003(\005\022\033\n\023append_block_co"
  ...
  "ing_present\030\002 \001(\010\022\032\n\022cord_xfer_pure_sec\030"
  ...
  "s\030\003 \003(\0132\037.coordinator_proto.LogicalRange"
  "\022\026\n\016interval_count\030\004 \001(\005\022\036\n\026cord_lp_use_"
  "global_hub\030\005 \001(\010\"\034\n\rKeyFromClient\022\013\n\003key"
  ...
  "rdUpdate\022$.coordinator_proto.CordUpdateR"
  "equest\032%.coordinator_proto.ReplyProxyIPs"
  "Ports\"\000\022^\n\025cordPlanBeginTransfer\022\".coord"
  "inator_proto.CordPlanKeyOnly\032\037.coordinat"
  "or_proto.RepIfSuccess\"\000\022i\n\034cordPlanWaitT"
  "ransferComplete\022&.coordinator_proto.Cord"
  "PlanWaitRequest\032\037.coordinator_proto.RepI"
  "fSuccess\"\000\022e\n\032uploadCordLocalParityApply"
  "\022$.coordinator_proto.CordUpdateRequest\032\037"
  ".coordinator_proto.RepIfSuccess\"\000\022l\n!upl"
  "oadCordLocalParityViaGlobalHub\022$.coordin"
  "ator_proto.CordUpdateRequest\032\037.coordinat"
...
const ::_pbi::DescriptorTable descriptor_table_coordinator_2eproto = {
    false, false, 5140, descriptor_table_protodef_coordinator_2eproto,
    "coordinator.proto",
...
ReplyProxyIPsPorts::ReplyProxyIPsPorts(const ReplyProxyIPsPorts& from)
  ...
  new (&_impl_) Impl_{
    ...
    , /*decltype(_impl_._group_ids_cached_byte_size_)*/{0}
    , decltype(_impl_.append_block_ids_){from._impl_.append_block_ids_}
    , /*decltype(_impl_._append_block_ids_cached_byte_size_)*/{0}
    , decltype(_impl_.append_block_counts_){from._impl_.append_block_counts_}
    , /*decltype(_impl_._append_block_counts_cached_byte_size_)*/{0}
...
inline void ReplyProxyIPsPorts::SharedCtor(
  ...
  new (&_impl_) Impl_{
    ...
    , /*decltype(_impl_._group_ids_cached_byte_size_)*/{0}
    , decltype(_impl_.append_block_ids_){arena}
    , /*decltype(_impl_._append_block_ids_cached_byte_size_)*/{0}
    , decltype(_impl_.append_block_counts_){arena}
    , /*decltype(_impl_._append_block_counts_cached_byte_size_)*/{0}
    , decltype(_impl_.cord_transfer_plan_key_){}
    , decltype(_impl_.sum_append_size_){uint64_t{0u}}
    , /*decltype(_impl_._cached_size_)*/{}
...
inline void ReplyProxyIPsPorts::SharedDtor() {
  ...
  _impl_.append_block_ids_.~RepeatedField();
  _impl_.append_block_counts_.~RepeatedField();
...
// @@protoc_insertion_point(message_clear_start:coordinator_proto.ReplyProxyIPsPorts)
  ...
  _impl_.append_block_ids_.Clear();
  _impl_.append_block_counts_.Clear();
    ...
    switch (tag >> 3) {
      ...
      case 7:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 58)) {
          ...
          goto handle_unusual;
        continue;
      // repeated int32 append_block_ids = 8;
      case 8:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 66)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::PackedInt32Parser(_internal_mutable_append_block_ids(), ptr, ctx);
          CHK_(ptr);
        } else if (static_cast<uint8_t>(tag) == 64) {
          _internal_add_append_block_ids(::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      // repeated int32 append_block_counts = 9;
      case 9:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 74)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::PackedInt32Parser(_internal_mutable_append_block_counts(), ptr, ctx);
          CHK_(ptr);
        } else if (static_cast<uint8_t>(tag) == 72) {
          _internal_add_append_block_counts(::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* ReplyProxyIPsPorts::_InternalSerialize(
  ...
  // repeated int32 append_block_ids = 8;
  {
    int byte_size = _impl_._append_block_ids_cached_byte_size_.load(std::memory_order_relaxed);
    if (byte_size > 0) {
      target = stream->WriteInt32Packed(
          8, _internal_append_block_ids(), byte_size, target);
    }
  }

  // repeated int32 append_block_counts = 9;
  {
    int byte_size = _impl_._append_block_counts_cached_byte_size_.load(std::memory_order_relaxed);
    if (byte_size > 0) {
      target = stream->WriteInt32Packed(
          9, _internal_append_block_counts(), byte_size, target);
    }
  }
...
// @@protoc_insertion_point(message_byte_size_start:coordinator_proto.ReplyProxyIPsPorts)
  ...
  {
    size_t data_size = ::_pbi::WireFormatLite::
      Int32Size(this->_impl_.append_block_ids_);
    if (data_size > 0) {
      total_size += 1 +
        ::_pbi::WireFormatLite::Int32Size(static_cast<int32_t>(data_size));
    }
    int cached_size = ::_pbi::ToCachedSize(data_size);
    _impl_._append_block_ids_cached_byte_size_.store(cached_size,
                                    std::memory_order_relaxed);
    total_size += data_size;
  }
  ...
  {
    size_t data_size = ::_pbi::WireFormatLite::
      Int32Size(this->_impl_.append_block_counts_);
    if (data_size > 0) {
      total_size += 1 +
        ::_pbi::WireFormatLite::Int32Size(static_cast<int32_t>(data_size));
    }
    int cached_size = ::_pbi::ToCachedSize(data_size);
    _impl_._append_block_counts_cached_byte_size_.store(cached_size,
                                    std::memory_order_relaxed);
    total_size += data_size;
  }
...
void ReplyProxyIPsPorts::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  _this->_impl_.append_block_ids_.MergeFrom(from._impl_.append_block_ids_);
  _this->_impl_.append_block_counts_.MergeFrom(from._impl_.append_block_counts_);
  if (!from._internal_cord_transfer_plan_key().empty()) {
...
void ReplyProxyIPsPorts::InternalSwap(ReplyProxyIPsPorts* other) {
  ...
  _impl_.append_block_ids_.InternalSwap(&other->_impl_.append_block_ids_);
  _impl_.append_block_counts_.InternalSwap(&other->_impl_.append_block_counts_);
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
