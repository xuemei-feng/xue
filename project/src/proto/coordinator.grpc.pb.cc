...
static const char* coordinatorService_method_names[] = {
  ...
  "/coordinator_proto.coordinatorService/uploadRackCuUpdate",
  "/coordinator_proto.coordinatorService/pullRackCuXferTiming",
...
coordinatorService::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options)
  ...
  , rpcmethod_uploadRackCuUpdate_(coordinatorService_method_names[10], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_pullRackCuXferTiming_(coordinatorService_method_names[11], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_getValue_(coordinatorService_method_names[12], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_getStripe_(coordinatorService_method_names[13], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_getBlocks_(coordinatorService_method_names[14], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_getDegradedReadBlocks_(coordinatorService_method_names[15], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_getDegradedReadBlock_(coordinatorService_method_names[16], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_getDegradedReadBlockBreakdown_(coordinatorService_method_names[17], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_getRecovery_(coordinatorService_method_names[18], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_getRecoveryBreakdown_(coordinatorService_method_names[19], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_fullNodeRecovery_(coordinatorService_method_names[20], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_multiBlockRecovery_(coordinatorService_method_names[21], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_delByKey_(coordinatorService_method_names[22], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_delByStripe_(coordinatorService_method_names[23], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
...
::grpc::Status coordinatorService::Stub::uploadRackCuUpdate(::grpc::ClientContext* context, const ::coordinator_proto::RackCuUpdateRequest& request, ::coordinator_proto::ReplyProxyIPsPorts* response) {
  return ::grpc::internal::BlockingUnaryCall< ::coordinator_proto::RackCuUpdateRequest, ::coordinator_proto::ReplyProxyIPsPorts, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_uploadRackCuUpdate_, context, request, response);
}

void coordinatorService::Stub::async::uploadRackCuUpdate(::grpc::ClientContext* context, const ::coordinator_proto::RackCuUpdateRequest* request, ::coordinator_proto::ReplyProxyIPsPorts* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::coordinator_proto::RackCuUpdateRequest, ::coordinator_proto::ReplyProxyIPsPorts, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_uploadRackCuUpdate_, context, request, response, std::move(f));
}

void coordinatorService::Stub::async::uploadRackCuUpdate(::grpc::ClientContext* context, const ::coordinator_proto::RackCuUpdateRequest* request, ::coordinator_proto::ReplyProxyIPsPorts* response, ::grpc::ClientUnaryReactor* reactor) {
  ::grpc::internal::ClientCallbackUnaryFactory::Create< ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_uploadRackCuUpdate_, context, request, response, reactor);
}

::grpc::ClientAsyncResponseReader< ::coordinator_proto::ReplyProxyIPsPorts>* coordinatorService::Stub::PrepareAsyncuploadRackCuUpdateRaw(::grpc::ClientContext* context, const ::coordinator_proto::RackCuUpdateRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::coordinator_proto::ReplyProxyIPsPorts, ::coordinator_proto::RackCuUpdateRequest, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_uploadRackCuUpdate_, context, request);
}

::grpc::ClientAsyncResponseReader< ::coordinator_proto::ReplyProxyIPsPorts>* coordinatorService::Stub::AsyncuploadRackCuUpdateRaw(::grpc::ClientContext* context, const ::coordinator_proto::RackCuUpdateRequest& request, ::grpc::CompletionQueue* cq) {
  auto* result =
    this->PrepareAsyncuploadRackCuUpdateRaw(context, request, cq);
  result->StartCall();
  return result;
}

::grpc::Status coordinatorService::Stub::pullRackCuXferTiming(::grpc::ClientContext* context, const ::coordinator_proto::RackCuXferTimingPullRequest& request, ::coordinator_proto::ReplyFromCoordinator* response) {
  return ::grpc::internal::BlockingUnaryCall< ::coordinator_proto::RackCuXferTimingPullRequest, ::coordinator_proto::ReplyFromCoordinator, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_pullRackCuXferTiming_, context, request, response);
}

void coordinatorService::Stub::async::pullRackCuXferTiming(::grpc::ClientContext* context, const ::coordinator_proto::RackCuXferTimingPullRequest* request, ::coordinator_proto::ReplyFromCoordinator* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::coordinator_proto::RackCuXferTimingPullRequest, ::coordinator_proto::ReplyFromCoordinator, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_pullRackCuXferTiming_, context, request, response, std::move(f));
}

void coordinatorService::Stub::async::pullRackCuXferTiming(::grpc::ClientContext* context, const ::coordinator_proto::RackCuXferTimingPullRequest* request, ::coordinator_proto::ReplyFromCoordinator* response, ::grpc::ClientUnaryReactor* reactor) {
  ::grpc::internal::ClientCallbackUnaryFactory::Create< ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_pullRackCuXferTiming_, context, request, response, reactor);
}

::grpc::ClientAsyncResponseReader< ::coordinator_proto::ReplyFromCoordinator>* coordinatorService::Stub::PrepareAsyncpullRackCuXferTimingRaw(::grpc::ClientContext* context, const ::coordinator_proto::RackCuXferTimingPullRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::coordinator_proto::ReplyFromCoordinator, ::coordinator_proto::RackCuXferTimingPullRequest, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_pullRackCuXferTiming_, context, request);
}

::grpc::ClientAsyncResponseReader< ::coordinator_proto::ReplyFromCoordinator>* coordinatorService::Stub::AsyncpullRackCuXferTimingRaw(::grpc::ClientContext* context, const ::coordinator_proto::RackCuXferTimingPullRequest& request, ::grpc::CompletionQueue* cq) {
  auto* result =
    this->PrepareAsyncpullRackCuXferTimingRaw(context, request, cq);
  result->StartCall();
  return result;
}
...
coordinatorService::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< coordinatorService::Service, ::coordinator_proto::RackCuUpdateRequest, ::coordinator_proto::ReplyProxyIPsPorts, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](coordinatorService::Service* service,
             ::grpc::ServerContext* ctx,
             const ::coordinator_proto::RackCuUpdateRequest* req,
             ::coordinator_proto::ReplyProxyIPsPorts* resp) {
               return service->uploadRackCuUpdate(ctx, req, resp);
             }, this)));
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      coordinatorService_method_names[11],
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< coordinatorService::Service, ::coordinator_proto::RackCuXferTimingPullRequest, ::coordinator_proto::ReplyFromCoordinator, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](coordinatorService::Service* service,
             ::grpc::ServerContext* ctx,
             const ::coordinator_proto::RackCuXferTimingPullRequest* req,
             ::coordinator_proto::ReplyFromCoordinator* resp) {
               return service->pullRackCuXferTiming(ctx, req, resp);
             }, this)));
  AddMethod(new ::grpc::internal::RpcServiceMethod(
...
::grpc::Status coordinatorService::Service::uploadRackCuUpdate(::grpc::ServerContext* context, const ::coordinator_proto::RackCuUpdateRequest* request, ::coordinator_proto::ReplyProxyIPsPorts* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
...
::grpc::Status coordinatorService::Service::pullRackCuXferTiming(::grpc::ServerContext* context, const ::coordinator_proto::RackCuXferTimingPullRequest* request, ::coordinator_proto::ReplyFromCoordinator* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
