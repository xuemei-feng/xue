...
namespace ECProject
{
  ...
  void Config::validateConfig() const
  {
    ...
    assert((CodeType == "UniLRC" || CodeType == "AzureLRC" || CodeType == "OptimalLRC" || CodeType == "UniformLRC" || CodeType == "XueLRC") && "Error: CodeType must be UniLRC, AzureLRC, OptimalLRC, UniformLRC, or XueLRC");
